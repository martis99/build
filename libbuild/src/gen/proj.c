...
static const prop_pol_t s_proj_props[] = {
	...
	[PROJ_PROP_LIB]	       = { .name = STRS("LIB") },
	[PROJ_PROP_DLIB]       = { .name = STRS("DLIB") },
	[PROJ_PROP_COPYFILES]  = { .name = STRS("COPYFILES"), .flags = PPF_ARR },
	[PROJ_PROP_DCOPYFILES] = { .name = STRS("DCOPYFILES"), .flags = PPF_ARR },

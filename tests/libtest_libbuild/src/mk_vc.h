...
static const char *SLN_TEST = "SLNDIR := $(CURDIR)\n"
			      ...
			      "\t@$(MAKE) -C test run\n"
			      "\n"
			      "test/coverage: check test/compile\n"
...
static const char *OS_SLN =
	...
	"\n"
	"kernel-bin/coverage: check kernel-bin/compile\n"
	...
	"\n"
	"kernel-elf/coverage: check kernel-elf/compile\n"
	"\t@$(MAKE) -C os/kernel/elf coverage\n"
	"\n"
	"image-disk: check boot-bin kernel-bin kernel-elf\n"
	...
	"\n"
	"image-floppy: check boot-bin kernel-bin kernel-elf\n"
...
static const char *OS_PROJ_KERNEL_BIN = "OUTDIR := $(SLNDIR)/bin/$(CONFIG)-$(PLATFORM)/os/kernel/bin/\n"
					...
					"endif\n"
					"\n"
					".PHONY: all check check_coverage kernel-bin compile coverage clean\n"
					"\n"
					"all: kernel-bin\n"
					"\n"
					"check:\n"
...
static const char *OS_PROJ_KERNEL_ELF = "OUTDIR := $(SLNDIR)/bin/$(CONFIG)-$(PLATFORM)/os/kernel/elf/\n"
					...
					"endif\n"
					"\n"
					".PHONY: all check check_coverage kernel-elf compile coverage clean\n"
					"\n"
					"all: kernel-elf\n"
					"\n"
					"check:\n"
